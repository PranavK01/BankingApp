...
--  
--INSERT INTO customer (user_id, email, first_name, last_name, password, contact_num, current_account_num, saving_account_num) VALUES ("s", "hfjkdasf@kfj.com", "Swet", "Sahu", "123", "758275325", 20050, 20057);
--
into
        customer
        (current_account_num, email, first_name, last_name, password, contact_num, saving_account_num, user_id) 
    values
        (?, ?, ?, ?, ?, ?, ?, ?)
...
insert 
    into
        current_account
        (user_id, account_type, balance, currency, status, account_number) 
    values
        (?, ?, ?, ?, ?, ?)
